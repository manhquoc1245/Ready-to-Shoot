...
[CreateAssetMenu(fileName = "Player Variant", menuName = "Rts/Character Data", order = 2)]
public class CharacterDataSO : ScriptableObject
{
    [Header("Data")]
    public Sprite characterSprite;          // CharacterSprite for the character selection scene
    public Sprite characterImage;           // The character image for the character selection scene
    public Sprite iconSprite;               // Sprite use on the player UI on gameplay scene
    public Sprite iconAvatar;               // Sprite use on the player UI on gameplay scene for his death
    public string characterName;            // Character name
    public GameObject characterPrefab;      // Prefab of the spaceship to use on gameplay scene
    public GameObject characterEPrefab;     // Sprite for the character on the endgame scene UI    
