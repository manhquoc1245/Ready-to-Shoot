...
public static class SaveSystem {
    ...
    public static void SaveGameData () {
        ...
        string path = Application.persistentDataPath + $"/ReadyToShootData{activeSaveSlot}.save";
    ...
    public static GameData LoadGameData(int slotToLoad) {
        string path = Application.persistentDataPath + $"/ReadyToShootData{slotToLoad}.save";
        if (!File.Exists(path))
            return null;
        BinaryFormatter formatter = new BinaryFormatter();
    ...
    public static void DeleteFile (int slotToDelete) {
        File.Delete(Application.persistentDataPath + $"/ReadyToShootData{slotToDelete}.save");
    }
